...
export class Init1636199774505 implements MigrationInterface {
    name = 'Init1636199774505'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `manner` (`id` int NOT NULL AUTO_INCREMENT, `user_id` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `phone_number` varchar(255) NOT NULL, `point` int NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `region_id` int NULL, `university_id` int NULL, UNIQUE INDEX `IDX_e12875dfb3b1d92d7d7c5377e2` (`email`), UNIQUE INDEX `IDX_01eea41349b6c9275aec646eee` (`phone_number`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `order_menu` ADD CONSTRAINT `FK_3f68e4390f5d103a5efcfd3fd1c` FOREIGN KEY (`order_id`) REFERENCES `order`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `order_menu` ADD CONSTRAINT `FK_618cfc966ad6dc5f50504bcba7d` FOREIGN KEY (`menu_id`) REFERENCES `menu`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `menu` ADD CONSTRAINT `FK_a9c5473205703022c7a53a410c2` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `restaurant` ADD CONSTRAINT `FK_848ac5e4e3e511560d07e36a257` FOREIGN KEY (`category_id`) REFERENCES `category`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `zone` ADD CONSTRAINT `FK_bbf299b3c534c78fd7896f7df67` FOREIGN KEY (`university_id`) REFERENCES `university`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `zone` ADD CONSTRAINT `FK_5b545fdb303b329fde24d0d4279` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `university` ADD CONSTRAINT `FK_d3b5700d08c2113fdcde2e9e35a` FOREIGN KEY (`region_id`) REFERENCES `region`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
        await queryRunner.query("ALTER TABLE `manner` ADD CONSTRAINT `FK_298c85d87247dd15bead6f7c7b2` FOREIGN KEY (`user_id`) REFERENCES `user`(`id`) ON DELETE CASCADE ON UPDATE CASCADE");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `user` DROP FOREIGN KEY `FK_1518391a178a27840edf478c7b9`");
        await queryRunner.query("ALTER TABLE `user` DROP FOREIGN KEY `FK_68c168fe38b5826502b831f9f83`");
        await queryRunner.query("ALTER TABLE `manner` DROP FOREIGN KEY `FK_298c85d87247dd15bead6f7c7b2`");
        await queryRunner.query("ALTER TABLE `university` DROP FOREIGN KEY `FK_d3b5700d08c2113fdcde2e9e35a`");
        await queryRunner.query("ALTER TABLE `zone` DROP FOREIGN KEY `FK_5b545fdb303b329fde24d0d4279`");
        await queryRunner.query("ALTER TABLE `zone` DROP FOREIGN KEY `FK_bbf299b3c534c78fd7896f7df67`");
        await queryRunner.query("ALTER TABLE `restaurant` DROP FOREIGN KEY `FK_848ac5e4e3e511560d07e36a257`");
        await queryRunner.query("ALTER TABLE `menu` DROP FOREIGN KEY `FK_a9c5473205703022c7a53a410c2`");
        await queryRunner.query("ALTER TABLE `order_menu` DROP FOREIGN KEY `FK_618cfc966ad6dc5f50504bcba7d`");
        await queryRunner.query("ALTER TABLE `order_menu` DROP FOREIGN KEY `FK_3f68e4390f5d103a5efcfd3fd1c`");
