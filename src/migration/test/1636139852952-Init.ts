...
export class Init1636139852952 implements MigrationInterface {
    name = 'Init1636139852952'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "menu" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "price" integer NOT NULL, "image_key" varchar NOT NULL, "restaurant_id" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "content" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "restaurant_id" integer, "creator_id" integer, "fee_id" integer)`);
        await queryRunner.query(`CREATE TABLE "restaurant" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "account" varchar NOT NULL, "open_at" datetime NOT NULL, "close_at" datetime NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "category_id" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "name" varchar NOT NULL, "phone_number" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "region_id" integer, "university_id" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_01eea41349b6c9275aec646eee0" UNIQUE ("phone_number"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_menu" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "price" integer NOT NULL, "image_key" varchar NOT NULL, "restaurant_id" integer, CONSTRAINT "FK_a9c5473205703022c7a53a410c2" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`);
        await queryRunner.query(`INSERT INTO "temporary_menu"("id", "title", "price", "image_key", "restaurant_id") SELECT "id", "title", "price", "image_key", "restaurant_id" FROM "menu"`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_order"("id", "title", "content", "created_at", "updated_at", "restaurant_id", "creator_id", "fee_id") SELECT "id", "title", "content", "created_at", "updated_at", "restaurant_id", "creator_id", "fee_id" FROM "order"`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_restaurant"("id", "account", "open_at", "close_at", "created_at", "updated_at", "category_id") SELECT "id", "account", "open_at", "close_at", "created_at", "updated_at", "category_id" FROM "restaurant"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "name" varchar NOT NULL, "phone_number" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "region_id" integer, "university_id" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_01eea41349b6c9275aec646eee0" UNIQUE ("phone_number"), CONSTRAINT "FK_68c168fe38b5826502b831f9f83" FOREIGN KEY ("region_id") REFERENCES "region" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_1518391a178a27840edf478c7b9" FOREIGN KEY ("university_id") REFERENCES "university" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_user"("id", "email", "name", "phone_number", "created_at", "updated_at", "region_id", "university_id") SELECT "id", "email", "name", "phone_number", "created_at", "updated_at", "region_id", "university_id" FROM "user"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "name" varchar NOT NULL, "phone_number" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "region_id" integer, "university_id" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_01eea41349b6c9275aec646eee0" UNIQUE ("phone_number"))`);
        await queryRunner.query(`INSERT INTO "user"("id", "email", "name", "phone_number", "created_at", "updated_at", "region_id", "university_id") SELECT "id", "email", "name", "phone_number", "created_at", "updated_at", "region_id", "university_id" FROM "temporary_user"`);
        ...
        await queryRunner.query(`CREATE TABLE "restaurant" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "account" varchar NOT NULL, "open_at" datetime NOT NULL, "close_at" datetime NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "category_id" integer)`);
        await queryRunner.query(`INSERT INTO "restaurant"("id", "account", "open_at", "close_at", "created_at", "updated_at", "category_id") SELECT "id", "account", "open_at", "close_at", "created_at", "updated_at", "category_id" FROM "temporary_restaurant"`);
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "content" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "restaurant_id" integer, "creator_id" integer, "fee_id" integer)`);
        await queryRunner.query(`INSERT INTO "order"("id", "title", "content", "created_at", "updated_at", "restaurant_id", "creator_id", "fee_id") SELECT "id", "title", "content", "created_at", "updated_at", "restaurant_id", "creator_id", "fee_id" FROM "temporary_order"`);
        ...
        await queryRunner.query(`CREATE TABLE "menu" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "price" integer NOT NULL, "image_key" varchar NOT NULL, "restaurant_id" integer)`);
        await queryRunner.query(`INSERT INTO "menu"("id", "title", "price", "image_key", "restaurant_id") SELECT "id", "title", "price", "image_key", "restaurant_id" FROM "temporary_menu"`);
